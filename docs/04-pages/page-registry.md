...
| ORG-003 | Модули и план | Platform | Organization admin | Full Product / Wave 12 | Wave 12 demo-plan contract ready; real billing TBD | Не реализовано |
...
| EX-012 | Жалоба на объявление / организацию | Exchange | Участник | Full Product / Wave 11 | Wave 11 contract implemented/submitted | Реализовано на preview; PR #10 submitted |
| PA-001 | Организации платформы | Platform admin | Platform admin | Full Product / Wave 11 | Wave 11 Exchange-control contract implemented/submitted | Реализовано на preview; PR #10 submitted |
| PA-002 | Модули и entitlements | Platform admin | Platform admin | Full Product / Wave 12 | Wave 12 manual demo-subscription contract ready; real billing TBD | Не реализовано |
| PA-003 | Модерация и жалобы | Platform admin | Moderator | Full Product / Wave 11 | Wave 11 preview implemented/submitted; KYC/legal remain disabled | Реализовано на preview; PR #10 submitted |
| PA-004 | Платформенный аудит | Platform admin | Platform admin | Full Product / Wave 11 | Wave 11 contract implemented/submitted | Реализовано на preview; PR #10 submitted |
