...
| EX-002 | Поиск грузов | Exchange | Участник | Full Product / Wave 10 | Wave 10 contract ready | Не реализовано |
...
| EX-005 | Поиск транспорта | Exchange | Участник | Full Product / Wave 10 | Wave 10 contract ready | Не реализовано |
...
| EX-009 | Отклики и предложения | Exchange | Участники объекта | Full Product / Wave 10 | Wave 10 contract ready | Не реализовано |
| EX-010 | Выбор исполнителя / контакты | Exchange | Владелец и выбранный | Full Product / Wave 10 | Wave 10 selection contract ready; contacts disabled | Не реализовано |
