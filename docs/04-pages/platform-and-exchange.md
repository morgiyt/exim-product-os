...
Статус: рабочий draft для Launch MVP. Контракт объявлений Wave 9 уточнён в [отдельной спецификации](./exchange-listings); точная административная, response, contacts и trust-механика зависит от OQ-034…OQ-045.
