...
| TASK-2026-008 | Канонические задачи, чаты и in-app уведомления | Full Product / Wave 6 | 1 | in_progress | Codex | Independent reviewer / human | Владелец продукта или delegate | [Открыть](./tasks/TASK-2026-008-tasks-chats-notifications) | Stacked base TASK-2026-007 @ `857725a` | Tasks/comments, conversations/messages/attachments, read state and notifications |
