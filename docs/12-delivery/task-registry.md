...
| TASK-2026-011 | EXIM Exchange — объявления грузов и транспорта | Full Product / Wave 9 | 1 | in_progress | Codex | Independent reviewer / human | Владелец продукта или delegate | [Открыть](./tasks/TASK-2026-011-exchange-listings) | Stacked base TASK-2026-010 @ `418cd62` | REQ-007 independent listings without Private OS conversion or OQ invention |
