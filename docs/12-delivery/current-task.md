...
| Поле | Значение |
|---|---|
| Current task | `TASK-2026-006` |
| Название | AgreementBasis → Shipment → Trip → tracking и документы |
| Revision | `1` |
| Статус | `in_progress` |
| Owner authorization | Full-product roadmap утверждён 2026-09-17, D-086…D-089 |
| Task | [TASK-2026-006](./tasks/TASK-2026-006-shipment-execution) |
| Product OS ref | `product-os-task-2026-006-r1` |
| Application repository | `https://github.com/morgiyt/exim-super-app.git` — private |
| Application stacked base | `task/TASK-2026-005-quote-to-offer-workflow` @ `a880ed0` |
| Implementation branch | `task/TASK-2026-006-shipment-execution` |
...
| Следующее действие | contractual gate, exactly one Shipment, Trip execution, published tracking and versioned documents |
